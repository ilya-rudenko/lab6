...
public class Movie implements Comparable<Movie>, Serializable {
    ...
    public static Movie collectMovie(StreamManager streamManager){
        ...
        Movie movie = new Movie(movieName,new Coordinates(xCoordinate,yCoordinate),movieOscarsCount,goldenPalmCount,movieGenre,mpaaRating,new Person(personName,(long)personHeight,eyeColor,hairColor,nationality,new Location((long)personX,personY,personZ)));
        movie.setTime(LocalDateTime.now());
        return movie;
    }
